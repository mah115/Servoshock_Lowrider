 ...
 ***/
void ServoInterpolate( uint16_t *channel, uint32_t currentTime, uint32_t time1, uint16_t pulseWidth1, uint32_t time2, uint16_t pulseWidth2 ) {
	if (currentTime < time1 || currentTime > time2 || time1 > time2) return 0;  //return 0 if time is out of bounds
